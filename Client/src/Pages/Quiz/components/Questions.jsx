...
//       setFetching(true);
//       try {
//         const response = await axios.get("http://localhost:3000/quiz/getQuestions");
//         setData(response.data.data.questions);
//       } catch (err) {
//         console.log(err);
//       }
...
//     // Instead of setting the counter here, call the setCounter function passed from QuizPage
//     setCounter();
//   };
